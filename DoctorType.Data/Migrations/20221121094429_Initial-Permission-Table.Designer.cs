...
namespace DoctorType.Data.Migrations
{
    ...
    [Migration("20221121094429_Initial-Permission-Table")]
    partial class InitialPermissionTable
    {
            ...
            modelBuilder.Entity("DoctorType.Domain.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1m,
                            CreateDate = new DateTime(2022, 11, 21, 13, 14, 29, 601, DateTimeKind.Local).AddTicks(2808),
                            IsDelete = false,
