...
namespace DoctorType.Data.Migrations
{
    ...
    [Migration("20221208071243_Initial-AdvertisementCategory-Table")]
    partial class InitialAdvertisementCategoryTable
    {
            ...
            modelBuilder.Entity("DoctorType.Domain.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1m,
                            CreateDate = new DateTime(2022, 12, 8, 10, 42, 43, 135, DateTimeKind.Local).AddTicks(1173),
                            IsDelete = false,
