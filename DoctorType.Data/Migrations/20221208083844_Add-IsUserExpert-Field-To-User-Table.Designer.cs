...
namespace DoctorType.Data.Migrations
{
    ...
    [Migration("20221208083844_Add-IsUserExpert-Field-To-User-Table")]
    partial class AddIsUserExpertFieldToUserTable
    {
            ...
            modelBuilder.Entity("DoctorType.Domain.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1m,
                            CreateDate = new DateTime(2022, 12, 8, 12, 8, 44, 5, DateTimeKind.Local).AddTicks(809),
                            IsDelete = false,
