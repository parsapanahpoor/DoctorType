...
namespace DoctorType.Data.Migrations
{
    ...
    [Migration("20221209105537_initial-LogExpertsSeeProjectsDetail-table")]
    partial class initialLogExpertsSeeProjectsDetailtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorType.Domain.Entites.Adevrtisement.Advertisemenet", b =>
                {
                    ...
                    b.Property<int>("AdvertismenetState")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoctorType.Domain.Entites.Adevrtisement.LogExpertsSeeProjectsDetail", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.ToTable("LogExpertsSeeProjectsDetail");
                });
            ...
            modelBuilder.Entity("DoctorType.Domain.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1m,
                            CreateDate = new DateTime(2022, 12, 9, 14, 25, 36, 964, DateTimeKind.Local).AddTicks(9693),
                            IsDelete = false,
            ...
            modelBuilder.Entity("DoctorType.Domain.Entites.Adevrtisement.LogExpertsSeeProjectsDetail", b =>
                {
                    b.HasOne("DoctorType.Domain.Entites.Adevrtisement.Advertisemenet", "Advertisement")
                        .WithMany("LogExpertsSeeProjectsDetail")
                        .HasForeignKey("AdvertisementId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DoctorType.Domain.Entites.Adevrtisement.Advertisemenet", b =>
                {
                    b.Navigation("AdvertisementSelectedSkills");

                    b.Navigation("LogExpertsSeeProjectsDetail");
                });
