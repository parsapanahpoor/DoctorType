...
namespace DoctorType.Data.Migrations
{
    ...
    [Migration("20221209114213_initial-LogExpertsSeeProjectsDetail-tabl")]
    partial class initialLogExpertsSeeProjectsDetailtabl
    {
            ...
            modelBuilder.Entity("DoctorType.Domain.Entities.Account.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1m,
                            CreateDate = new DateTime(2022, 12, 9, 15, 12, 12, 540, DateTimeKind.Local).AddTicks(2635),
                            IsDelete = false,
